...
| C6 Dense/global scoring | In progress | Grouped big-JIT boundary `c379a512`, diagnostics plan `0b6e2bb9`, batch-bound score constraints `77eec9c5`, local score capture grouping `702df30b`, shared pass score-constraint application `3c758d5c`, and redundant correction-branch removal are validated; five-iteration GPU replay `61007337` reached final merged FSC-AUC `0.9970972713`; dense host-stage separation remains. |
...
| Production lines | 69,212 | 69,196 | -16 | Pass |
| Nonblank production lines | 63,751 | 63,727 | -24 | Pass |
