...
- [`significance.py`](../../recovar/em/dense_single_volume/helpers/significance.py) -- `_compute_k_class_significance_batched()`: canonical batched coarse pass
  for both K=1 and multi-class refinement; it collects per-image significant
  samples for pass 2.
